...
class getTestControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.9x.1s9I'] ?? $container->load('get_ServiceLocator_9x_1s9IService'))->withContext('App\\Controller\\TestController', $container));
